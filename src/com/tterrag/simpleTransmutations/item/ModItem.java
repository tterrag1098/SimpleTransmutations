...
public class ModItem
{
	...
	public static void registerRecipes()
	{
		...
		GameRegistry.addRecipe(new ItemStack(tinyGlowstone, 2), new Object[] {
				"R",
		...
		if (RecipeIDs.woodToObsidian)
		{
			GameRegistry.addShapelessRecipe(new ItemStack(Block.obsidian),
					new Object[] { wood1, wood1, wood1, tinyGlowstone });

			GameRegistry.addShapelessRecipe(new ItemStack(Block.obsidian),
					new Object[] { wood2, wood2, wood2, tinyGlowstone });

			GameRegistry.addShapelessRecipe(new ItemStack(Block.obsidian),
					new Object[] { wood3, wood3, wood3, tinyGlowstone });

			GameRegistry.addShapelessRecipe(new ItemStack(Block.obsidian),
					new Object[] { wood4, wood4, wood4, tinyGlowstone });

			GameRegistry.addShapelessRecipe(new ItemStack(Block.wood, 3),
					new Object[] { Block.obsidian, tinyGlowstone });
		}

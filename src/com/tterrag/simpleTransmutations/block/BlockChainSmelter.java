...
public class BlockChainSmelter extends BlockContainer {
    ...
    protected BlockChainSmelter(int par1, boolean par2)
    {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileChainSmelter tileentityfurnace = (TileChainSmelter)world.getBlockTileEntity(x, y, z);

            if (tileentityfurnace != null)
            {
                par5EntityPlayer.openGui(SimpleTransmutations.instance, 0, world, x, y, z);
            }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileChainSmelter tileentityfurnace = (TileChainSmelter)par1World.getBlockTileEntity(par2, par3, par4);
